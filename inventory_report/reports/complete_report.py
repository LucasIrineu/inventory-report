...
class CompleteReport(SimpleReport):
    def generate(products: List[Dict]):
        ...
        comp_with_most_products = most_products_report(sorted_companies)
        companies_stock = sort_companies_stock(sorted_companies)
        result = (
            f"Data de fabricação mais antiga: {oldest_manufacture}\n"
            f"Data de validade mais próxima: {nearest_expiration_date}\n"
            f"Empresa com mais produtos: {comp_with_most_products['name']}\n"
